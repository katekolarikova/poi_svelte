...
export class LeafletMapWithPois {
    imap = {};
    control = {};
    overlays = {};
...
export class LeafletMapOstrava {
    imap = {};
    control = {};
    overlays = {};
    ...
    constructor(id, descriptor, activeLayer = "") {
        let defaultLayer = this.baseLayers.OpenTopoMap;
        if (activeLayer) {
            defaultLayer = this.baseLayers[activeLayer];
        }
        this.imap = L.map(id, {
...
export class LeafletMapTransport {
    imap = {};
    control = {};
    overlays = {};
    ...
    constructor(id, descriptor, activeLayer = "") {
        let defaultLayer = this.baseLayers.OPNVKarte;
        if (activeLayer) {
            defaultLayer = this.baseLayers[activeLayer];
        }
        this.imap = L.map(id, {
